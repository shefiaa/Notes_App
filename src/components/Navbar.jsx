...
function Navbar({ onSearch }) {
    return (
        <nav className="bg-gray-800 px-5 sm:px-24 py-5"> 
            <div className="container flex flex-wrap justify-between items-center mx-auto gap-5 sm:gap-0">
                <a href="/" className="flex items-center">
                    <span className="self-center text-blue-600 text-3xl font-bold whitespace-nowrap uppercase text-white">My Notes</span>
                </a>
