    ...
    return (
        <React.Fragment>
            <section className="container">
                <div className="bg-gray-900 text-white px-5 sm:px-24 py-10 md:py-20">
                    <h2 className="text-2xl font-bold text-white mb-8">Catatan Aktif</h2>
                    {
            ...
            <section className="container">
                <div className="bg-gray-800 text-white px-5 sm:px-24 py-10 md:py-20">
                    <h2 className="text-2xl font-bold text-white mb-8">Arsip</h2>
                    {
